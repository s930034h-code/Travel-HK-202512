...
import { MapPin, Utensils, Bus, ShoppingBag, BedDouble, Plane, Sparkles, Map, Info, Edit3, Plus, Trash2, Save, X, Check } from 'lucide-react';
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-fadeIn">
            <div className="bg-paper w-full max-w-md max-h-[90vh] overflow-y-auto rounded-3xl border-2 border-stone-800 shadow-sketch-lg p-5">
                ...
                <form onSubmit={handleSaveForm} className="space-y-4">
                    ...
                    <div>
                        <label className="block text-xs font-bold text-stone-500 mb-1">描述 / 備註</label>
                        <textarea 
                            value={editFormData.description || editFormData.notes || ''} 
